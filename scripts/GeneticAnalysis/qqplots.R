...
x <- 3
workdir <- '/Users/andrewmarderstein/Documents/Research/GTEx/Infiltration/GTEx_infil/'
dir.create(paste0(workdir,'output/GeneticAnalysis/qq/'))
qqout <- paste0(workdir,'output/GeneticAnalysis/qq/','GTEx.pheno',i,'.ALL_EBM.qq')
tiff(qqout,width=400*x,height=400*x,res=100*x,units="px")
print(g)
dev.off()
