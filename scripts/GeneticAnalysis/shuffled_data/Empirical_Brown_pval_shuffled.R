...
f <- paste0('/athena/elementolab/scratch/anm2868/GTEx/GTEx_infil/output/GeneticAnalysis/GWAS/shuffled_data/GTEx.pheno',i,'.ALL_EBM.sig.txt')
# if (!file.exists(f)) {
if (1==1) {
  ...
  df.pheno <- fread('/athena/elementolab/scratch/anm2868/GTEx/GTEx_infil/output/GeneticAnalysis/gtex_all.filter.name.shuffled_data.txt',data.table=F,header=T,stringsAsFactors = F)
  ...
  df1 <- fread(paste0('/athena/elementolab/scratch/anm2868/GTEx/GTEx_infil/output/GeneticAnalysis/GWAS/shuffled_data/GTEx.pheno',i,'.1.qassoc'),data.table=F,stringsAsFactors = F)
  ...
  df2 <- fread(paste0('/athena/elementolab/scratch/anm2868/GTEx/GTEx_infil/output/GeneticAnalysis/GWAS/shuffled_data/GTEx.pheno',i,'.2.qassoc'),data.table=F,stringsAsFactors = F)
  ...
  # xcell
  print('xcell')
  df3 <- fread(paste0('/athena/elementolab/scratch/anm2868/GTEx/GTEx_infil/output/GeneticAnalysis/GWAS/shuffled_data/GTEx.pheno',i,'.3.qassoc'),data.table=F,stringsAsFactors = F)
  ...
  print('Writing...')  
  f <- paste0('/athena/elementolab/scratch/anm2868/GTEx/GTEx_infil/output/GeneticAnalysis/GWAS/shuffled_data/GTEx.pheno',i,'.ALL_EBM.txt')
