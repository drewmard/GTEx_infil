...
hot_tissueSpecific.R (for k-means clusters)
hot_tissueSpecific_quintile.R (for quintile clusters)
hot_tissueSpecific_quintile_spec.R (for whole blood & lung heatmap)
